# -*- coding: utf-8 -*-
#
# radproc documentation build configuration file, created by
# sphinx-quickstart on Mon Apr 24 16:38:50 2017.
#
...
#html_theme = 'classic'
html_theme_options = {'sidebarwidth': 300, 'sticky_navigation': True}
html_title = project
...
latex_documents = [
    (master_doc, 'radproc.tex', u'radproc Documentation',
     u'Kreklow', 'manual'),
]
...
man_pages = [
    (master_doc, 'radproc', u'radproc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'radproc', u'radproc Documentation',
     author, 'radproc', 'One line description of project.',
     'Miscellaneous'),
]
